    ...
    GoogleService._search = function (term, query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = BASE_URL + "/autocomplete/json?&input=" + encodeURIComponent(term) + "&" + queryString.stringify(query);
    ...
    GoogleService._searchDetails = function (placeid, query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = BASE_URL + "/details/json?" + queryString.stringify(__assign({}, query, { placeid: placeid }));
                        return [4 /*yield*/, fetch(url)];
                    case 1:
                        res = _a.sent();
